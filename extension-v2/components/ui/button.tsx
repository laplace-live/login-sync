...
const buttonVariants = cva(
  'focus-ring inline-flex appearance-none items-center justify-center gap-1 whitespace-nowrap font-medium disabled:cursor-not-allowed disabled:opacity-50',
  {
    ...
    compoundVariants: [
      ...
      // Solid
      { variant: 'solid', tint: 'default', className: 'bg-fg text-bg shadow-fg/20 not-disabled:hover:bg-fg/80' },
      { variant: 'solid', tint: 'accent', className: 'bg-ac text-bg shadow-ac/25 not-disabled:hover:bg-ac/80' },
      { variant: 'solid', tint: 'gray', className: 'bg-gray-500 text-bg shadow-gray-500/25 not-disabled:hover:bg-gray-400', },
      { variant: 'solid', tint: 'red', className: 'bg-red-500 text-bg shadow-red-500/25 not-disabled:hover:bg-red-400' },
      { variant: 'solid', tint: 'orange', className: 'bg-orange-500 text-bg shadow-orange-500/25 not-disabled:hover:bg-orange-400', },
      { variant: 'solid', tint: 'amber', className: 'bg-amber-500 text-bg shadow-amber-500/25 not-disabled:hover:bg-amber-400', },
      { variant: 'solid', tint: 'yellow', className: 'bg-yellow-500 text-bg shadow-yellow-500/25 not-disabled:hover:bg-yellow-400', },
      { variant: 'solid', tint: 'lime', className: 'bg-lime-500 text-bg shadow-lime-500/25 not-disabled:hover:bg-lime-400', },
      { variant: 'solid', tint: 'green', className: 'bg-green-500 text-bg shadow-green-500/25 not-disabled:hover:bg-green-400', },
      { variant: 'solid', tint: 'emerald', className: 'bg-emerald-500 text-bg shadow-emerald-500/25 not-disabled:hover:bg-emerald-400', },
      { variant: 'solid', tint: 'teal', className: 'bg-teal-500 text-bg shadow-teal-500/25 not-disabled:hover:bg-teal-400', },
      { variant: 'solid', tint: 'cyan', className: 'bg-cyan-500 text-bg shadow-cyan-500/25 not-disabled:hover:bg-cyan-400', },
      { variant: 'solid', tint: 'sky', className: 'bg-sky-500 text-bg shadow-sky-500/25 not-disabled:hover:bg-sky-400' },
      { variant: 'solid', tint: 'blue', className: 'bg-blue-500 text-bg shadow-blue-500/25 not-disabled:hover:bg-blue-400', },
      { variant: 'solid', tint: 'indigo', className: 'bg-indigo-500 text-bg shadow-indigo-500/25 not-disabled:hover:bg-indigo-400', },
      { variant: 'solid', tint: 'violet', className: 'bg-violet-500 text-bg shadow-violet-500/25 not-disabled:hover:bg-violet-400', },
      { variant: 'solid', tint: 'purple', className: 'bg-purple-500 text-bg shadow-purple-500/25 not-disabled:hover:bg-purple-400', },
      { variant: 'solid', tint: 'fuchsia', className: 'bg-fuchsia-500 text-bg shadow-fuchsia-500/25 not-disabled:hover:bg-fuchsia-400', },
      { variant: 'solid', tint: 'pink', className: 'bg-pink-500 text-bg shadow-pink-500/25 not-disabled:hover:bg-pink-400', },
      { variant: 'solid', tint: 'rose', className: 'bg-rose-500 text-bg shadow-rose-500/25 not-disabled:hover:bg-rose-400', },
      { variant: 'solid', tint: 'white', className: 'bg-white text-black shadow-white/25 not-disabled:hover:bg-white/80' },
      { variant: 'solid', tint: 'black', className: 'bg-black text-white shadow-black/25 not-disabled:hover:bg-black/80' },
      ...
      // Ghost
      { variant: 'ghost', tint: 'default', className: 'not-disabled:hover:bg-ac/10 not-disabled:hover:text-ac focus-visible:ring-ac/30 data-open:bg-ac/10 data-open:text-ac' },
      { variant: 'ghost', tint: 'accent', className: 'not-disabled:hover:bg-ac/10 not-disabled:hover:text-ac/80' },
      { variant: 'ghost', tint: 'gray', className: 'not-disabled:hover:bg-gray-500/10 not-disabled:hover:text-gray-500', },
      { variant: 'ghost', tint: 'red', className: 'not-disabled:hover:bg-red-500/10 not-disabled:hover:text-red-500' },
      { variant: 'ghost', tint: 'orange', className: 'not-disabled:hover:bg-orange-500/10 not-disabled:hover:text-orange-500' },
      { variant: 'ghost', tint: 'amber', className: 'not-disabled:hover:bg-amber-500/10 not-disabled:hover:text-amber-500' },
      { variant: 'ghost', tint: 'yellow', className: 'not-disabled:hover:bg-yellow-500/10 not-disabled:hover:text-yellow-500' },
      { variant: 'ghost', tint: 'lime', className: 'not-disabled:hover:bg-lime-500/10 not-disabled:hover:text-lime-500' },
      { variant: 'ghost', tint: 'green', className: 'not-disabled:hover:bg-green-500/10 not-disabled:hover:text-green-500' },
      { variant: 'ghost', tint: 'emerald', className: 'not-disabled:hover:bg-emerald-500/10 not-disabled:hover:text-emerald-500' },
      { variant: 'ghost', tint: 'teal', className: 'not-disabled:hover:bg-teal-500/10 not-disabled:hover:text-teal-500' },
      { variant: 'ghost', tint: 'cyan', className: 'not-disabled:hover:bg-cyan-500/10 not-disabled:hover:text-cyan-500' },
      { variant: 'ghost', tint: 'sky', className: 'not-disabled:hover:bg-sky-500/10 not-disabled:hover:text-sky-500' },
      { variant: 'ghost', tint: 'blue', className: 'not-disabled:hover:bg-blue-500/10 not-disabled:hover:text-blue-500' },
      { variant: 'ghost', tint: 'indigo', className: 'not-disabled:hover:bg-indigo-500/10 not-disabled:hover:text-indigo-500' },
      { variant: 'ghost', tint: 'violet', className: 'not-disabled:hover:bg-violet-500/10 not-disabled:hover:text-violet-500' },
      { variant: 'ghost', tint: 'purple', className: 'not-disabled:hover:bg-purple-500/10 not-disabled:hover:text-purple-500' },
      { variant: 'ghost', tint: 'fuchsia', className: 'not-disabled:hover:bg-fuchsia-500/10 not-disabled:hover:text-fuchsia-500' },
      { variant: 'ghost', tint: 'pink', className: 'not-disabled:hover:bg-pink-500/10 not-disabled:hover:text-pink-500' },
      { variant: 'ghost', tint: 'rose', className: 'not-disabled:hover:bg-rose-500/10 not-disabled:hover:text-rose-500' },
      { variant: 'ghost', tint: 'white', className: 'not-disabled:hover:bg-white/10 not-disabled:hover:text-white/80' },
      { variant: 'ghost', tint: 'black', className: 'not-disabled:hover:bg-black/10 not-disabled:hover:text-black/80' },

      // Link
      { variant: 'link', tint: 'default', className: 'not-disabled:hover:text-ac data-open:text-ac' },
